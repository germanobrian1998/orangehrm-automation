/**
 * HRM API Suite - HRM API Client
 * Provides typed methods for the OrangeHRM REST API v2.
 */
...
export class HrmApiClient extends BaseApiClient {
  ...
  async getEmployeeList(page: number = 1, pageSize: number = 50): Promise<EmployeeListResponse> {
    try {
