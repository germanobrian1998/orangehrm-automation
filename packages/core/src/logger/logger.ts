/**
 * Core framework - Winston-based structured logging service
 */
...
export class Logger {
  ...
  /** Log an assertion outcome with ✓/✗ prefix */
...
export const createLogger = (context: string = 'Test'): Logger => new Logger(context);
